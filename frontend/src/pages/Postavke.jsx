...
export default function Postavke() {
    ...
    const [tenantBuildingId, setTenantBuildingId] = useState(buildingId ? String(buildingId) : '');
    ...
    const handleAddTenant = async (e) => {
        ...
        setTenantMessage('');
        try {
            const selectedBuildingId = tenantBuildingId || (buildingId ? String(buildingId) : '');
            if (!selectedBuildingId) {
                setTenantMessage('Odaberite zgradu');
                return;
            }
                            ...
                            <form onSubmit={handleAddTenant} className="auth-form">
                                <div className="auth-field">
                                    ...
                                    <select
                                        ...
                                        value={tenantBuildingId}
                                        onChange={(e) => setTenantBuildingId(e.target.value)}
                                        required
